		...
		<tr>
			<c:choose>
				<c:when test="${message.isNew=='0'}">
					...
					<td>Subject: <i><a href="<c:url value="/messages/${user_id}/${message.message_id}/reply" />">${message.header}</a></i></td>
			 ...
			 <tr class="active">		
					...
					<td><b>Subject: <i><a href="<c:url value="/messages/${user_id}/${message.message_id}/reply" />">${message.header}</a></i></b></td>
